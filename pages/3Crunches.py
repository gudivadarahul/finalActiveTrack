        ...
        with poseSolutions.Pose(min_detection_confidence=0.7, min_tracking_confidence=0.7) as poseTrack:
            ...
            while repsCounter < reps:
                ...
                try:
                    ...
                    angle = calcAngle(L_knee, L_hip, L_shoulder)
                    ...
                    if angle > 100:
                        ...
                        cv2.putText(image, 'GO HIGHER', (270,250), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,0,0), 1, cv2.LINE_AA)
                    elif angle < 50 and motion == "up":
                        motion = "down"
                        repsCounter += 1
            ...
            if setsCounter != sets:
                try:
                    ...
                    cv2.putText(image, 'LAY BACK DOWN' , (155,350), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255,255,255), 3, cv2.LINE_AA)
                    cv2.imshow('Mediapipe Feed', image)
                    cv2.waitKey(1)
                    time.sleep(3)     
                except:
...
with col1:
    st.write("# Crunches")
    st.write("For crunches place your legs and shoulders in view of the camera!")
...
with col2:
    lottie_diagram_url = 'https://assets9.lottiefiles.com/packages/lf20_sz79nzyi.json'
